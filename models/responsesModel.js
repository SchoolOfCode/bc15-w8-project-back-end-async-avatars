...
export async function createResponse(response) {
  ...
  // Define the SQL query for inserting a new response into the 'responses' table
  const queryText = `
...
export async function updateResponseById(id, updates) {
  ...
  // Define the SQL query for updating the specified response in the 'responses' table
  const queryText = `
      UPDATE responses
...
export async function deleteResponseById(id) {
  ...
  // Define the SQL query for deleting the specified response from the 'responses' table
  const queryText = `
